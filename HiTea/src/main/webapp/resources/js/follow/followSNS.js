function scrollShowFollow() {
	
	
	var pNo = 1;
	snsAllShowFollow(pNo);
...
var login_sm_id;
function snsAllShowFollow(pNo) {
	login_sm_nickname = $("#login_sm_nickname").val();
	var ssid = $("#shm_id").val();
	$.getJSON("follow.sns?page="+pNo+"&ssid="+ssid,function(data){
