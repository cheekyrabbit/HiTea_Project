function scrollShowPageHeart() {
	
	
	var pNo = 1;
	snsAllShowPageHeart(pNo);
...
function snsAllShowPageHeart(pNo) {
	login_sm_nickname = $("#login_sm_nickname").val();
	var ssid = $("#pageId2").val();
	$.getJSON("page.go.heart?page="+pNo+"&pageId="+ssid,function(data){
